...
/**
 * You might have Message class similar to XMLParser class, When you receive a
 * message you will parse it and assign necesary values to Message object
 */
public class Common {
    ...
    public static String BROADCAST = "Broadcast",
            ...
            REQUEST_SUPPLY_LIST_LOCKDOWN = "RequestSupplyLock",
